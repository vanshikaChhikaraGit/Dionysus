...
if(isLoading||!meeting){
  ...
  return (
    <div>
        <div className="p-8">
            <div className="mx-auto flex max-w-2xl items-center justify-between gap-x-8 border-b pb-6 lg:mx-w-none">
                ...
                <h1>
                    ...
                    <div className="mt-1 text-bas font-semibold leading-6 text-gray-900">
                        {meeting.name}
                    </div>
                </h1>
            </div>
